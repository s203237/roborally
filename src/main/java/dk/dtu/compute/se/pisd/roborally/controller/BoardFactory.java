...
switch (name){
    ...
    private static void createBasicBoard(Board board){
        Object[][] boardConfig = {
                ...
                {6, 3, new Walls(Walls.WallType.VERTICAL,Heading.EAST)},
                {3, 4, new Walls(Walls.WallType.VERTICAL,Heading.WEST)},
...
//                {6,4, new Gear(Gear.GearType.RIGHT)},
    ...
    private static void createAdvancedBoard(Board board){
        Object[][] boardConfig = {
                {3, 4, new Walls(Walls.WallType.VERTICAL,Heading.WEST)},
                {6, 5, new Walls(Walls.WallType.VERTICAL,Heading.SOUTH)},
                {6, 2, new Walls(Walls.WallType.VERTICAL,Heading.SOUTH)},
                {6, 3, new Walls(Walls.WallType.VERTICAL,Heading.EAST)},
                {3, 4, new Walls(Walls.WallType.VERTICAL,Heading.WEST)},
                {1, 3, new Walls(Walls.WallType.VERTICAL,Heading.NORTH)},
                {2, 3, new Walls(Walls.WallType.VERTICAL,Heading.WEST)},
                {3, 5, new Walls(Walls.WallType.VERTICAL,Heading.NORTH)},
                {5, 1, new Walls(Walls.WallType.VERTICAL,Heading.NORTH)},
                {6, 6, new Walls(Walls.WallType.VERTICAL,Heading.WEST)},
                {1, 3, new ConveyorBelt(Heading.SOUTH)},
                {1, 4, new ConveyorBelt(Heading.SOUTH)},
                {1, 5, new ConveyorBelt(Heading.EAST)},
                {2, 5, new ConveyorBelt(Heading.EAST)},
                ...
                {4, 5, new ConveyorBelt(Heading.WEST)},
                {5, 5, new ConveyorBelt(Heading.WEST)},
                {5, 6, new ConveyorBelt(Heading.SOUTH)},
                {5, 7, new ConveyorBelt(Heading.SOUTH)},
